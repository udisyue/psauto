...
writeDict.fileRplace('/home/work/idata/price/dict/base/manaul_price_tool.dict')
...
if offset != 0 :
    ...
    in_param["activity_id"] = "2020000500"
    ...
    if jrlt['service_status']['msg'] == 'success' and jrlt['detail_response']['detail_hotel']['detail_ota_list'][0]['hotel_status']==2:
        ...
        if cost == base + 1:
            print '#####coupon price right, success'
        else:
            print '#####coupon price right, success'
...
writeDict.fileRecov('/home/work/idata/price/dict/base/manaul_price_tool.dict')